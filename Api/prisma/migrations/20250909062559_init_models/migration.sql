/*
  ...
  - You are about to drop the `Adjunto` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "public"."Adjunto" DROP CONSTRAINT "Adjunto_tareaId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Tarea" DROP CONSTRAINT "Tarea_proyectoId_fkey";

-- DropTable
DROP TABLE "public"."Adjunto";
