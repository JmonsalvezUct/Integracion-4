...
export const tasksService = {
    ...
    updateTask: async (taskId, data) => {
        ...
        for (const field of Object.keys(taskData)) {
    ...
    changeStatus: async (taskId, data) => {
        const updatedTask = await tasksRepository.changeStatus(taskId, data.status);
        const user = await prisma.user.findUnique({
            where: { id: data.userId },
            select: { name: true },
        });
    ...
    changePriority: async (taskId, priority, userId) => {
