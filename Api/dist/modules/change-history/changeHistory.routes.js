 ...
 */
router.get("/task/:taskId", authMiddleware, changeHistoryController.getByTask);
router.get("/project/:projectId", authMiddleware, changeHistoryController.getHistoryByProject);
router.get("/projects/:projectId/tasks/:taskId", authMiddleware, rbacMiddleware(["admin", "developer", "guest"]), changeHistoryController.getByTaskInProject);
export default router;
//# sourceMappingURL=changeHistory.routes.js.map